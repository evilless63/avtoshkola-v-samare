...
<html>
	<head>
		<meta charset="utf-8">
			<title>Документы - Самообследование - Автомобилист63</title>
			<!-- HEADER, MENU, BANNER -->	
			<?php 
						...
						<div class="row">
							<div class="col-md-12">
								<ol class="breadcrumb">
								  ...
								  <li><a href="/documenty/samoobsledovanie/">Самообследование</a></li>
								</ol>
							</div>
							<div class="col-md-12">
							...
							<div class="col-md-12 embed" >
							    <iframe src="otchet-o-rezultatah-samoobsledovanija.pdf" type="pdf" width="90%" height="1000"></iframe>
							</div>
						</div>
					</div>
				</section>
