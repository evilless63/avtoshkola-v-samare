...
<html>
	<head>
		<meta charset="utf-8">
			<title>Документы - Устав - Автомобилист63</title>
			<!-- HEADER, MENU, BANNER -->	
			<?php 
						...
						<div class="row">
							<div class="col-md-12">
								<ol class="breadcrumb">
								  ...
								  <li><a href="/documenty/uchreditelnye-dokumenty/">Устав</a></li>
								</ol>
							</div>
							<div class="col-md-12">
								<h1>Устав</h1>
							...
							<div class="col-md-12 embed">
							    <iframe src="ustav.pdf" type="pdf" width="90%" height="1000"></iframe>
							</div>
						</div>
					</div>
				</section>
