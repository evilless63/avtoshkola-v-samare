...
$action_id_edit = htmlspecialchars($_POST['news_id'], ENT_QUOTES);
$action_title_edit = htmlspecialchars($_POST['news_title_ed'], ENT_QUOTES);
$action_text_edit = $_POST['news_text_ed'];
$action_date_edit = date("d-m-Y");



$answer = update_action_admin($pdo, $action_title_edit, $action_text_edit, $uploadfile, $action_date_edit, $action_id_edit);
?>
